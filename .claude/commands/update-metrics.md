...
**Conversion Rates:**
- Application → Interview: (interviews / applied) × 100%
- Interview → Offer: (offers / interviews) × 100%
- Application → Offer: (offers / applied) × 100%

**Time Metrics:**
- Average days to first response (applied date → interview/rejection date)
...
|--------------|------|-----------|--------|
| Application → Interview | X% (Y/Z) | 20-30% (typical) | [Above/Below/On par] |
| Interview → Offer | X% (Y/Z) | 20-30% (typical) | [Above/Below/On par] |
| Application → Offer | X% (Y/Z) | 5-10% (typical) | [Above/Below/On par] |
...
**Checks Performed:**
- ✅ All folders have status.md files (X/X)
- ✅ All applied entries have dates
- ✅ All calculations validated
- [✅/❌] Fit scores valid (0-10 range)
- [✅/❌] No orphaned data
...
- Conversion Rate: Z% (applications → interviews)
...
📁 Updated: insights/metrics-dashboard.md

💡 For deeper analysis, run `/weekly-review`
```
...
```
ℹ️ No applications found. Metrics dashboard will show empty state.
...
```
⚠️ Limited data for statistical analysis (< 5 applications).
